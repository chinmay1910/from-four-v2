...
>(({ className, children, ...props }, forwardedRef) => {
  return (
    <RadioGroupPrimitives.Item
      ...
      className={cx(
        // base
        "group relative w-full rounded-md border p-2 text-left shadow-sm transition focus:outline-none",
        // background color
        "bg-white dark:bg-gray-950",
        // border color
        "border-gray-300 dark:border-gray-800",
        "data-[state=checked]:border-rose-500",
        "data-[state=checked]:dark:border-rose-500",
        // disabled
  ...
  return (
    <div
      className={cx(
        ...
        "bg-white dark:bg-gray-950",
        // checked
        "group-data-[state=checked]:border-0 group-data-[state=checked]:border-transparent group-data-[state=checked]:bg-rose-500",
        // disabled
